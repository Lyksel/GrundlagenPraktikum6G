...
\section{Vergleich der 2.5D EM Simulation mit der 1D-Simulation}
...
\section{Anpassung im Schematic und Re-Simulation}
    ...
    \end{figure}
    Daraufhin ergibt sich nach der EM-Simulation des Layouts mit dem Knick ergibt sich das folgende Dämpfungsdiagramm (links ohne Knick, rechts mit Knick):
    \begin{figure}[H]
        \centering
