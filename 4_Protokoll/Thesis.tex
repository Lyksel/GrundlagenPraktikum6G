...
\usepackage{graphicx} 
\usepackage{wrapfig} % in der Präambel hinzufügen
\usepackage{lipsum}  % optional, nur für Blindtext
...
\usepackage[ngerman]{datetime2} % For date formatting in German
\usepackage{tikz}
\usepackage{pgfplots}
\usepackage{amsmath}
...
\HRule \\[0.4cm]
{ \huge \bfseries Versuch 4: Modulierte Daten, Modulation, Demodulation und Trägerfrequenz}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\DTMdate{\the\year-\ifnum\month<10 0\fi\the\month-\ifnum\day<10 0\fi\the\day} % Zeigt das aktuelle Datum im deutschen Format, z.B. 4. Juni 2024
% Nur das Datum ohne Uhrzeit anzeigen
% \DTMnow gibt Datum und Uhrzeit aus, \DTMdate{YYYY-MM-DD} nur das Datum
...
\begin{acronym}[XXXXXX] % Adjust the width of the longest acronym
    ...
    \acro{AM}{Analoge Amplitudenmodulation}
    \acro{ASK}{Digitale Amplitudenmodulation}
    \acro{FM}{Frequenzmodulation}
    \acro{PM}{Phasenmodulation}
...
\input{Chapter/Versuchsaufbau}

\chapter{Durchführung}
\input{Chapter/Durchführung}
