...
eine nachfolgende Verarbeitung. Der Komparator besteht aus einem Operationsverstärker (Typ NCX2200GW), einem Spannungsteiler aus zwei Widerständen
...
\]
Der Schwellwert ist $U_{Ref}$ wurde so gewählt das groß genuge Signale sicher erkannt werden. Dabei werden jedoch Rauschen und Störsignale ignoriert.