...
\HRule \\[0.4cm]
{ \huge \bfseries Versuch 6: End-to-End Datenübertragung}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\chapter{Praktische Durchführung}
\input{Chapter/Durchführung}

\chapter{link budget scheiße}
\input{Chapter/linkbudget}
